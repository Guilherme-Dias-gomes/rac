...
//   const [isPlaying, setIsPlaying] = useState(false);
  ...
  const productData = {
    name: "PainelBT",
    tagline: "Um painel de baixa tensão (BT) é uma estrutura que abriga componentes elétricos para distribuição e controle de energia em sistemas de baixa tensão, geralmente até 1 kV. Esses painéis incluem disjuntores, contatores, relés, medidores e outros dispositivos para proteção, controle e medição de circuitos elétricos.",
